...
tbl_names_popular |> 
  ...
  labs(
    ...
    subtitle = 'Emmah & Noah are the most popular names of the decade',
    caption = 'Source: SSA',
    x = 'Number of Births',
    y = 'Name'
  ) +
...
plot_trends_in_letter <- function(my_letter) {
  tbl_names_by_letter |> 
    ...
    labs(
      ...
      subtitle = "By percentage of births for all names",
      caption = "Souce: SSA",
      x = "Year",
...
tbl_names_by_first_and_last_letter |> 
 ...
 labs(
   title = "Distribution of the First & Last Letters in Names in 2021",
   subtitle = "Source: SSA",
   x = "Last Letter" ,
   y =   "First Letter",
  fill ="Percent of Total Births"
 ) +
